...
public class APIConductor {
    ...
    public static void main(String[] args) throws ApiException {
         ...
         */
        ((ApiKeyAuth) api.getAuthentication("access_token")).setApiKey("3BJU7WSdxYVy");
        ((ApiKeyAuth) api.getAuthentication("client_id")).setApiKey("VxUGXKTjnPCa");
